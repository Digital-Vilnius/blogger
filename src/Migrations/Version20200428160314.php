 ...
 */
final class Version20200428160314 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD slug VARCHAR(255) NOT NULL, CHANGE updated updated DATETIME DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_389B783DAE07E975E237E06 ON tag (blog_id, name)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog CHANGE updated updated DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE category DROP slug, CHANGE updated updated DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE post CHANGE category_id category_id INT DEFAULT NULL, CHANGE updated updated DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE subscriber CHANGE updated updated DATETIME DEFAULT \'NULL\'');
        $this->addSql('DROP INDEX UNIQ_389B783DAE07E975E237E06 ON tag');
        $this->addSql('ALTER TABLE tag CHANGE updated updated DATETIME DEFAULT \'NULL\'');
