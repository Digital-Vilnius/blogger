 ...
 */
final class Version20200429182300 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD sms TINYINT(1) NOT NULL, CHANGE updated updated DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD phone VARCHAR(255) DEFAULT NULL, CHANGE updated updated DATETIME DEFAULT NULL, CHANGE api_token api_token VARCHAR(255) DEFAULT NULL, CHANGE password password VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
    }
